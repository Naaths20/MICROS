...
FINAL_IMAGE=${DISTDIR}/punto4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/punto4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
